...
* **seen** = 1D array to track visited vertices during BFS and DFS to prevent revisiting
...
* Calls `doBFS()` to perform BFS traversal
* Resets the `seen` array
* Calls `doDFS()` to perform DFS traversal
